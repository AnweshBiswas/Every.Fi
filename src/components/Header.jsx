      ...
      <header className="text-gray-600 body-font backdrop-filter backdrop-blur fixed top-0 w-full">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
            <a href="/students" className="mr-5 text-gray-50 hover:text-gray-100">Students</a>
            <a href="/millenials" className="mr-5 text-gray-50 hover:text-gray-100">Millenials</a>
            <a href="/parents" className="mr-5 text-gray-50 hover:text-gray-100">Parents</a>
            <a href="/contentCreation" className="mr-5 text-gray-50 hover:text-gray-100">Content Creators</a>
            <a href="/merchants" className="mr-5 text-gray-50 hover:text-gray-100">Merchants</a>
          </nav>
