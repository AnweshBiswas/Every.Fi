...
export const Comparison = () => {
  ...
  return (
    <div>
      <section className="text-gray-400 body-font bg-gradient-to-tr from-purple-900 to-black ">
        <div className="container px-5 py-24 mx-auto w-5/6 relative ">
          ...
          <div className="flex flex-wrap w-5/6 mx-auto">
            <div className="xl:w-1/2 lg:w-1/2 md:w-full px-8 py-6 border-gray-50">
              <h2 className="text-lg sm:text-xl text-white font-medium title-font mb-2">
                title
              </h2>
              <p className="leading-relaxed text-base mb-4">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                Commodi quidem nobis non eius, labore similique molestias
                voluptatibus autem error exercitationem.
              </p>
              <ul>
                <li>
                  <a>
                    <span className="bg-red-700 text-white w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
            ...
            <div className="xl:w-1/2 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-50">
              <h2 className="text-lg sm:text-xl text-white font-medium title-font mb-2">
                Shooting Stars
              </h2>
              <p className="leading-relaxed text-base mb-4">
              ...
              <ul>
                <li>
                  <a>
                    <span className="bg-green-700 text-white w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
          ...
          <button className="flex mx-auto mt-16 text-white bg-gradient-to-b from-purple-800 to-gray-900 shadow border-0 py-2 px-8 focus:outline-none hover:shadow-2xl rounded text-lg">
            Join Waitlist
          </button>
          <div
            className="absolute w-16 h-16 top-1/2 bg-black text-white rounded-full"
            style={{ left: "47.5%" }}
          >
            <div
              className="text absolute top-1/2 left-1/2 "
